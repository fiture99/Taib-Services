...
export function CustomerRegistration() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('http://localhost:8080/customer/customer_registration', {
        method: 'POST',
        headers: {
      ...
      setErrorMessage('An error occurred while registering the Customer');
    }
  };
          ...
          <MDBCardBody>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className='row'>
                ...
                <div className='col-md-6 mb-4'>
                  <MDBInput label='Street' type='text' name='street' value={formData.street} onChange={handleChange} required />
                </div>
              </div>
              <div className='d-grid gap-2'/>
              <MDBInput label='Contact Number' type='contact' name='contact' value={formData.contact} onChange={handleChange} required />
              <div className='d-grid gap-2 '/>
              <div className='mt-3'>
